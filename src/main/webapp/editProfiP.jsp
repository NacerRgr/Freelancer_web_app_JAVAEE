...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link" href="contProf?act=afficherProfessionnel"> <i
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<form action="controlleur?act=modifierProf" method="post" >
							<c:forEach items="${ sessionScope.unProf }" var="unprofprofil">
								<table class="table table-bordered" width="100%"
									...
									<thead>
										...
										<tr>
											...
											<li  class="">
											<div class="input-group">
											    <span class="input-group-addon pr-3"><i class="fas fa-solid fa-user"></i></span>
											<input type="text" name="nomPmodi" value="${ unprofprofil.getNom()}"
											class="form-control" />
											<input type="text" name="prenomPmodi" value=" ${ unprofprofil.getPrenom()}"
											class="form-control" />
											</div>
											</li>
											...
											<li>
											<div class="input-group">
											    <span class="input-group-addon pr-3"><i class="fas fa-solid fa-envelope"></i></span>
											<input  id="email" type="email" name="emailPmodi"  value="${ unprofprofil.getEmail()}"
											class="form-control"/>
											</div>
											</li>
											...
											<li  class="">
											<div class="input-group">
											<span class="input-group-addon pr-2"><i class="fas fa-sharp fa-solid fa-phone pr-2"></i></span>
											<input type="text" name="numPmodi"  value="${ unprofprofil.getNumTel()}"
											class="form-control" />
											</div>
											</li>
											...
											<li  class="py-1">
											<div class="input-group">
											<span class="input-group-addon pr-2"><i class="fas fa-solid fa-address-card pr-2"></i></span>
											<textarea type="text" name="adressPmodi"  class="form-control"> 
											...
											<li >
											<div class="input-group">
											<span class="input-group-addon pr-3">
											<i class="fas fa-solid fa-globe "></i>
											</span>
											<input  type="text" name="villePmodi" value="${ unprofprofil.getVille()}" class="form-control" />
											</div>
											</li>
								...
								<table class="table table-bordered" width="100%"
									...
									<tr height="300px">
											<td>
											<p class="font-weight-bold text-dark">à propos de moi<p>
											<ul class="list-unstyled">
											<div class="form-group">
											<li class="py-3">
											<textarea type="text" name="surmoiPmodi"  cols="30" rows="2" class="form-control">${ unprofprofil.getSurMoi() }</textarea>
											</li>
											</div>
								...
								<i class="fas fa-solid fa-check"></i>  valider
								</span>
								</button>
								</h6>
								</td>
