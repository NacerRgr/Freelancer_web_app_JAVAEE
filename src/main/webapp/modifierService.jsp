		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid d-flex justify-content-center ">
					...
					<h3 class="text-center text-dark"> Modifier le service</h3>
				     <c:forEach items="${afficherService}" var="service">
			
						<form  action="contProf?act=modifierService&cinp=${service.getIdService()}"  method="post">
							<fieldset>
								<div class="form-group">
									<label for="disabledTextInput">Titre de service</label> <input
										 type="text" name="titreSm"  value="${ service.getTitreS() }"id="disabledTextInput" class="form-control  shadow"
										placeholder="Entrer le service" required >
								</div>
								<div class="form-group">
									<label for="disabledSelect">Catégorie de service</label>
									 <select name="categorieSm" id="disabledSelect" class="form-control  shadow" required>
										<option selected ">Sélectionner une categoriée</option>
										<hr class="bg-dark">
								...
								<div class="form-group">
									<label for="disabledTextInput">Description</label> <input
										type="text" name="descriptionSm" value="${ service.getDescription() }" id="disabledTextInput" class="form-control  shadow"
										placeholder="Entrer le service" required>
								</div>
								<div class="form-group">
									<label for="disabledTextInput">Prix</label> <input
										type="text" name="prixSm" value="${ service.getPrix() }" id="disabledTextInput" class="form-control  shadow"
										placeholder="Entrer le service" required>
								</div>
