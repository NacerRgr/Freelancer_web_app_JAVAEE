...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link" href="contProf?act=mesClients"> 
			...
			<div id="content">
				...
				<div class="container w-50">
					...
					<div class="card shadow mb-4">
						...
						-->
						<div class="card-body">
							<c:forEach items="${MonClient}" var="mesClients" varStatus="boucle" >
						<b><center>${mesClients.getNom()} ${mesClients.getPrenom()}</center></b>
						
						
						 <form action="contProf?act=EvaluerClient&cinc=${mesClients.getCinClient()}&cinp=${requestScope.cinp}" method="post">
                ...
                <div class="mr-3">
                          <textarea class="form-control ml-4" placeholder="Ecrivez ici votre commentaire...." 
                                     name="commentaire" required>
                           </textarea>
                 </div>
                 <br>
                  <div class="buttons px-4 mt-0 text-center">
                  <button type="submit" class="btn btn-warning  rating-submit m-1">Evaluer</button>
                  </div>
                </form>
                </c:forEach>
                </div>	
