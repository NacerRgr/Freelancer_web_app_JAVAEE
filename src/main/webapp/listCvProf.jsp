			...
			<div id="content">
				...
				<div class="container w-50">
					...
					<div class="card shadow mb-4">
						...
						Ajout de CV sous format d'image
						</h6>
						<hr>
							<form action="AddImage" method="post" enctype="multipart/form-data">
										<input type="file" name="cvP" >
										 <input type="submit" value="Ajouter CV">
									</form>
							<!--  <table class="table">
								<thead>
									<tr>
					...
					<div class="card-body ">
						...
						<hr>
						<c:forEach items="${cvProf}" var="prof" varStatus="boucle" >
						
						<!-- ${cvProf} -->
						<p><center><img src="images/${prof}" width="500px" height="700px"></center></p>
						</c:forEach>
						</div>
					</div>
