...
<div class="navbar  shadow-sm">
		...
		<div class="navdiv">
			 <a class="btn btn-secondary">Mohamed Nacer Erragragy</a>
			...
			<div style="display: inline-block;">
				...
				<div class="dropdown-menu " aria-labelledby="hello">
					<a class="dropdown-item btn btn-outline-primary"
						href="ajouterBesoin.jsp">lister un besoin</a> <a
						class="dropdown-item btn btn-outline-primary"
						href="../ClientDashboardControll?choice=mesBesoins">Mes
						Besoins</a> 
					<a class="dropdown-item btn btn-outline-primary" href="ClientDashboardControll?choice=mesInvitaitons">Mes invitations envoyées</a> 
						...
						<a class="dropdown-item btn btn-outline-primary" href="#">Demande
	...
	<div class="shadow-lg p-4 mb-5 bg-white rounded div1">
		...
		<span>
			<h4 class=" h4 text-center">
				<i class="bi bi-briefcase-fill"></i> Ajouter Un Besoin
			</h4>
		</span>
		<form
			action="../ClientDashboardControll?choice=creer"
			 method="POST">
			<div class="mb-2">
				<label class="form-label">titre de besoin</label> 
				<input
					type="text" class="form-control" name="titre"
					placeholder="cherche un plombier" required>
			</div>
			<div class="mb-2">
			...
			<div class="mb-2">
				<button class="btn btn-success w-20 " type="submit">Créer</button>
			</div>
		</form>
</body>
</html>