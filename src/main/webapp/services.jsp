		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800 text-center">Gérer votre services</h1>
					<br>
					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Table des
								services
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<tbody>
										<c:forEach items="${afficherService}" var="service"
											varStatus="boucle">
											<tr>
												<td>${ service.getTitreS() }</td>
												 <!-- <span  class="invisible" >${ service.getIdService()} </span> -->
												<td>${ service.getDescription() }</td>
												<td>${ service.getPrix() }</td>
												<td>${ service.getCategorie() }</td>
											   <td>statut</td>	
												<td><center>
												<form action="contProf?act=valSermodifier&cinp=${ service.getIdService()}"  method="post" class="bg-white align-items-center" >
												<button class=" border border-white bg-white" type="submit" ><i class="fas fa-solid fa-pen"></i> 
												</button>
												</form>
												</center>
												</td>
												<td>
												<center>
												<form action="contProf?act=supprimerService&cinp=${ service.getIdService()}"  method="post" class=" border border-white bg-white align-items-center" >
												<button class=" border border-white bg-white" type="submit" ><i class="fas fa-solid fa-trash"></i>
												</button>
												</form>
												</center>
												</td>
