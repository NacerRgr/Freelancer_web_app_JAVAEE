...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link" href="contProf?act=afficherOffreClientP"> 
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					  <c:if test="${not empty deletInviC}">
      <div class="alert alert-primary alert-dismissible fade show" role="alert">
      <b> <c:out value="${deletInviC}" /></b>
						...
						<div class="card-body">
							 ...
							 <table class="table">
								<!--<thead>
								 ...
								 -->
								<tbody>
								<c:forEach items="${inviClient}" var="invClient" varStatus="boucle" >
									<tr>
										
										
										<td>image</td>
										<td>${invClient.getNomC()} ${invClient.getPrenomC()}</td>
									
										
										<td>
										<form action="contProf?act=AccepterClient&cinc=${invClient.getCinC()}&cinp=${invClient.getCinP()}" method="post">
										<button type="submit" class="btn btn-primary">Accepter</button>
										</form>
										</td>
										<td>
										<form action="contProf?act=RefuserClient&cinc=${invClient.getCinC()}&cinp=${invClient.getCinP()}" method="post">
