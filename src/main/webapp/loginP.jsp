                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                     <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Content(e) de vous revoir!</h1>
                                    </div>
                                    <form action="contProf?act=authentification" method="post" class="user">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Souviens-moi</label>
                                            </div>
                                        </div>
